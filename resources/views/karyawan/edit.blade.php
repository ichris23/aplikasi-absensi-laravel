    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $karyawan->nama_lengkap }}" class="form-control" placeholder="Nama Lengkap" name="nama_lengkap" autocomplete="off" required/>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $karyawan->jabatan }}" class="form-control" placeholder="Jabatan" name="jabatan" autocomplete="off" required/>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $karyawan->no_hp }}" class="form-control" placeholder="Nomor HP" name="no_hp" autocomplete="off" required/>
            </div>
        </div>
    </div>
    <div class="mb-3">
