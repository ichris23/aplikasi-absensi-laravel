    ...
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $departemen->kode_dept }}" class="form-control" placeholder="Kode Departemen" name="kode_dept" readonly autocomplete="off"/>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-12">
            <div class="input-icon mb-3">
                ...
                <input type="text" value="{{ $departemen->nama_dept }}" class="form-control" placeholder="Nama Departemen" name="nama_dept" autocomplete="off" required/>
            </div>
        </div>
    </div>
    <div class="row">
